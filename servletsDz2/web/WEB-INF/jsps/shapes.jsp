...
<body>
    ...
    <div>
        ...
        <form name="shapes" action="" method="post">
            <div>
            ...
            <div>
                <input id="trapeze" name="shape" type="radio" value="4" />
                <label for="trapeze">Трапеция</label>
            </div>
            <div>
                <input id="triangle" name="shape" type="radio" value="5" />
